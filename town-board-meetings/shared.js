...
function renderFilterBar(containerId) {
  return `
    <div class="filter-bar">
      <button class="filter-btn active" data-filter="all" onclick="filterFiles('all', this, '${containerId}')">All files</button>
      <button class="filter-btn" data-filter="agenda" onclick="filterFiles('agenda', this, '${containerId}')">Agendas</button>
      <button class="filter-btn" data-filter="minutes" onclick="filterFiles('minutes', this, '${containerId}')">Minutes</button>
    </div>`;
}
